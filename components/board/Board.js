...
export default class BoardView extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      game,
      board: this.createBoardData(game, props.pgn),
    };
  }

  shouldComponentUpdate(nextProps, nextState) {
    const nextPgn = nextProps.pgn;
    if (nextPgn !== this.state.pgn) {
      return true;
    }
    return false;
  }
  ...
  componentDidUpdate(prevProps) {
    const prevPgn = prevProps.pgn;
    if (prevPgn !== this.props.pgn) {
      console.log('Helo');
      this.setState({
        ...this.state,
        board: this.createBoardData(this.state.game, this.props.pgn),
      });
    }
  }
